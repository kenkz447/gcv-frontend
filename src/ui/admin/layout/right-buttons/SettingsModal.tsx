...
import { menuChangeBehaviour, menuChangePlacement } from '@/ui/admin/layout/nav/main-menu/menuReducer';
import { settingsChangeColor, settingsChangeLayout, settingsChangeNavColor, settingsChangeRadius } from '@/ui/admin/settings/settingsReducer';
                    ...
                    <OverlayScrollbarsComponent options={{ overflowBehavior: { x: 'hidden', y: 'scroll' } }} className="scroll-track-visible">
                        ...
                        <OptionGroup label="Menu Behaviour">
                            <>
                                <OptionItem
                                    label="PINNED"
                                    active={behaviour === MENU_BEHAVIOR.Pinned}
                                    onClick={() => handleChange(menuChangeBehaviour, MENU_BEHAVIOR.Pinned)}
                                >
                                    <Card className="rounded-md p-3 mb-1 no-shadow">
                                ...
                                <OptionItem
                                    label="UNPINNED"
                                    active={behaviour === MENU_BEHAVIOR.Unpinned}
                                    onClick={() => handleChange(menuChangeBehaviour, MENU_BEHAVIOR.Unpinned)}
                                >
                                    <Card className="rounded-md p-3 mb-1 no-shadow">
                                        <Figure className="figure-primary left" />
                                        <Figure className="figure-secondary right" />
